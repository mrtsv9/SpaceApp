package com.example.space.presentation.details_screen.view.custom_view
...
class CustomImageView : AppCompatImageView, View.OnTouchListener,
    ...
    private  fun fitToScreen() {
        ...
        val scaleX = viewWidth.toFloat() / imageWidth.toFloat() /** 3*/
        val scaleY = viewHeight.toFloat() / imageHeight.toFloat() /** 3*/
